...
public class classroomSignIn extends Fragment implements EasyPermissions.PermissionCallbacks {
     ...
     */
    private class MakeRequestTask extends AsyncTask<Void, Void, List<Course>> {
        ...
        /**
         * Fetch a list of the names of the first 10 courses the user has access to and
         * adds them to the users database.
         * @return List course, or a simple error message if no courses are
         *         found.
         * @throws IOException
         */
        private List<Course> getDataFromApi() throws IOException {
            ...
            for (Course course : courseResponse.getCourses()) {
                ...
                Database.addClass(new Classes(
                        ...
                        startDate,
                        Integer.parseInt(course.getRoom()),
                        course.getDescription(),
                        course.getSection()
                ));
            }

            classroomSignIn.setVisibility(View.INVISIBLE);
    ...
    private void showSnackbar(String message) {
        Snackbar snackbar = Snackbar.make(classroomView, message, Snackbar.LENGTH_LONG);
        snackbar.show();
    }
}